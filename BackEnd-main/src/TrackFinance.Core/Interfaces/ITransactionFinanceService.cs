...
public interface ITransactionFinanceService
{
  ...
  public Task<Result<List<TransactionDataDto>>> GetTransactionItemsByDateAsync(int userId, TransactionType transactionType,DateTime dateIni, DateTime dateEnd, CancellationToken cancellationToken = default);
}
